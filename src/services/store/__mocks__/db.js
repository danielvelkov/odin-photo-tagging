...
import WastelandReality from '../../../assets/images/waste_land_of_reality.webp';
import PrecariousWorld from '../../../assets/images/the_precarious_world.webp';
import SomeSuperstar from '../../../assets/images/some_kind_of_superstar.webp';
import RigSelfCritique from '../../../assets/images/rigorous_self_critique.webp';
import RemoteViewers from '../../../assets/images/remote_viewers_division.webp';
import RegularLaw from '../../../assets/images/regular_law_official.webp';
import OverHonourGlands from '../../../assets/images/overproductive_honour_glands.webp';
import OpioidAntagonist from '../../../assets/images/opioid_receptor_antagonist.webp';
import MazovianSocio from '../../../assets/images/mazovian_socio_economics.webp';
import MagBasedLife from '../../../assets/images/magnesium_based_lifeform.webp';
import FeministAgenda from '../../../assets/images/inexplicable_feminist_agenda.webp';
import IndirectTaxation from '../../../assets/images/indirect_modes_of_taxation.webp';
import HardcoreAesthetic from '../../../assets/images/hardcore_aesthetic.webp';
import { formatDurationBetweenDates } from '../../helpers';
...
export const MOCK_thoughts = [
  ...
  {
    id: 5,
    name: 'The Precarious World',
    image: PrecariousWorld,
    x: 2773,
    y: 1424,
    width: 156,
    height: 292,
  ...
  },
  {
    ...
    width: 347,
    height: 390,
    problem: `First, let's make this absolutely clear. No one is saying you're an *actual* superstar in the groupies-and-cocaine, riddled-with-hepatitis-C, strikes-a-lionesque-pose-with-a mic kind of way. You're not Guillaume le Million or Davy Dewis, no. You're a *metaphorical* superstar. You bring that rock-and-roll authenticity and passion to a line of work where people don't expect (or want) to see it. Where, some would say, it doesn't *belong*: law enforcement.`,
    solution: `They say the world isn't ready for a rock-and-roll cop. No one *wants* their state monopoly on violence to be mixed with celebrity worship. They 'claim to know' it would be dangerous for detectives to rise to the ranks of demigods and have sexual encounters with barely-legal cover girls. It would be 'insane', they say. To all this you say: Fuck off and die. In a cool voice. You people have no idea how *good* these cops are gonna get. They're gonna crack twenty cases a day. In the future, cops will be like astrophysicists. Or prime ministers. Or prophets. And you're the first one.`,
  },
  {
    id: 7,
    name: 'Rigorous Self-Critique',
    image: RigSelfCritique,
    x: 361,
    y: 321,
    width: 190,
    height: 248,
